...
class PwComponentsService {
	...
	public function setComponent($alias, $component, $description) {
		...
		$this->_loadConfigService()->setConfig($this->namespace, $alias, $component, $description);
	}
	...
	public function getComponents() {
		return $this->_loadConfigService()->getConfig($this->namespace);
	}
	...
	public function delComponent($alias) {
		return $this->_loadConfigService()->deleteConfigByName($this->namespace, $alias);
	}
