		...
		<div class="main cc">
			<div class="box_wrap register cc">
				...
				<div class="reg_cont_wrap">
					<div class="reg_cont">
						<form id="J_register_form" action="<?php echo Wekit::app()->baseUrl,'/','index.php?m=u&c=register&a=dorun'; ?>" method="POST">
						<div class="reg_form">
 ...
 if ($verify) {?>
				...
				<div class="reg_side">
					<div class="reg_side_cont">
						...
						<p><a rel="nofollow" href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=u&c=login&backurl=', rawurlencode($backurl); 
	...
	register_form.validate({
		...
		rules: {
			invitecode : {
				required	: true,
				remote		: {
					url : "<?php echo Wekit::app()->baseUrl,'/','index.php?m=u&c=register&a=checkInvitecode'; ?>",
					type : 'post',
					dataType: "json",
					data : {
						invitecode : function(){
			...
			username: {
				required	: true,
				remote		: {
					url : "<?php echo Wekit::app()->baseUrl,'/','index.php?m=u&c=register&a=checkusername'; ?>",
					type : 'post',
					dataType: "json",
			...
			password : {
				required: true,
				remote : {
					url : '<?php echo Wekit::app()->baseUrl,'/','index.php?m=u&c=register&a=checkpwd'; ?>',		//验证密码
					dataType: "json",
					type : 'post',
					data : {
						username : function(){
			...
			mobileCode : {
				required : true,
				remote : {
					url : '<?php echo Wekit::app()->baseUrl,'/','index.php?m=u&c=mobile&a=checkmobilecode'; ?>',		//验证手机验证码
					dataType: "json",
					type : 'post',
					data : {
						mobileCode : function(){
			...
			if(id == 'password') {
				...
				$(element).on('keyup', function(e){
					...
					if(e.keyCode !== 9) {
						...
						$.post('<?php echo Wekit::app()->baseUrl,'/','index.php?m=u&c=register&a=checkpwdStrong'; ?>', {
...
<?php if ($config['active.phone']) {?>
	//手机验证
	window.M_CHECK = '<?php echo Wekit::app()->baseUrl,'/','index.php?m=u&c=register&a=sendmobile'; ?>';
	window.M_CHECK_MOBILE = '<?php echo Wekit::app()->baseUrl,'/','index.php?m=u&c=register&a=checkmobile'; ?>';
