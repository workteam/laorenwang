...
<div class="tac"> </div>
	<div class="main_wrap">
		<div class="bread_crumb">
			...
			<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=my&c=follow'; ?>">我关注的人</a><?php if($type){?><em>&gt;</em><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=my&c=follow&type=', rawurlencode($type); ?>"><?php echo htmlspecialchars($typeArr[$type], ENT_QUOTES, 'UTF-8');?></a><?php }?>
		</div>
		<div class="main cc">
			<div class="main_body">
...
<div class="content_nav">
	<ul>
		...
		<li class="<?php echo Pw::isCurrent($li == 'visitor');?>"><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=my&c=visitor'; ?>">访问脚印</a></li>
						...
						<div class="content_type">
							<ul class="cc">
								<li class="<?php echo htmlspecialchars($classCurrent[0], ENT_QUOTES, 'UTF-8');?>"><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=my&c=follow'; ?>">全部</a></li>
								<?php  foreach ($typeArr as $key => $value) { ?>
								<li class="line"></li><li class="<?php echo htmlspecialchars($classCurrent[$key], ENT_QUOTES, 'UTF-8');?>"><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=my&c=follow&type=', rawurlencode($key); ?>"><?php echo htmlspecialchars($value, ENT_QUOTES, 'UTF-8');?></a></li>
								<?php  } ?>
							</ul>
						</div>
						<?php  if ($follows) { ?>
						<div class="fans_list">
							...
							<dl class="cc J_friends_items">
								...
								<dd>
									<div class="title">
										<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=space&uid=', rawurlencode($value['touid']); ?>" data-uid="<?php echo htmlspecialchars($value['touid'], ENT_QUOTES, 'UTF-8');?>" class="name J_user_card_show"><?php echo htmlspecialchars($value['username'], ENT_QUOTES, 'UTF-8');?></a>
									...
									<div class="num">
										关注<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=space&c=follows&uid=', rawurlencode($value['touid']); ?>"><?php echo htmlspecialchars($value['follows'], ENT_QUOTES, 'UTF-8');?></a><span>|</span>粉丝<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=space&c=fans&uid=', rawurlencode($value['touid']); ?>"><?php echo htmlspecialchars($value['fans'], ENT_QUOTES, 'UTF-8');?></a><span>|</span>帖子<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=space&c=thread&uid=', rawurlencode($value['touid']); ?>"><?php echo htmlspecialchars($value['postnum'], ENT_QUOTES, 'UTF-8');?></a>
									</div>
 ...
 echo htmlspecialchars(FollowController::bulidGroup($userType[$value['touid']]), ENT_QUOTES, 'UTF-8');
									...
									<div class="attribute">
										...
										<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=my&c=follow&a=delete&uid=', rawurlencode($value['touid']); ?>" class="core_unfollow J_unfollow_btn J_friends_unfollow" style="display:none;">取消关注</a>
									</div>
								</dd>
							</dl>
							<?php  } ?>
...
?>
	<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=my&c=follow&page=', rawurlencode($_page_i); 
				...
				<div class="box_wrap">
					...
					<div class="side_cate_list">
						<ul id="J_side_group_list" class="cc">
							<li>
								<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=my&c=follow'; ?>" class="title"><span class="">全部</span><em>(<?php echo htmlspecialchars($loginUser->info['follows'], ENT_QUOTES, 'UTF-8');?>)</em></a>
							</li>
							<?php  foreach ($typeArr as $key => $value) { ?>
							<li id="J_side_group_<?php echo htmlspecialchars($key, ENT_QUOTES, 'UTF-8');?>">
								<?php  if ($key > 0) { ?>
								<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=my&c=follow&a=deleteType&id=', rawurlencode($key); ?>" class="icon_del J_group_del" data-id="<?php echo htmlspecialchars($key, ENT_QUOTES, 'UTF-8');?>">删除</a>
								<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=my&c=follow&a=editType&id=', rawurlencode($key); ?>" class="icon_edit J_group_edit" data-id="<?php echo htmlspecialchars($key, ENT_QUOTES, 'UTF-8');?>" data-name="<?php echo htmlspecialchars($value, ENT_QUOTES, 'UTF-8');?>">编辑</a>
								<?php  } ?>
								<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=my&c=follow&type=', rawurlencode($key); ?>" class="title"><span class="J_name"><?php echo htmlspecialchars($value, ENT_QUOTES, 'UTF-8');?></span><em>(<?php  echo isset($typeCounts[$key]) ? $typeCounts[$key]['count'] : 0; ?>)</em></a>
							</li>
							<?php  } ?>
						</ul>
...
*/
	...
	$('#J_group_check_ul').data({
		'saveList' : function(elem, type, id){
			...
			$.post("<?php echo Wekit::app()->baseUrl,'/','index.php?m=my&c=follow&a=savetype'; ?>", {
				uid : elem.data('id'),
				id : id,
				type : (type ? 1 : 0)
			}, function(data){
		...
		'saveCreat' : function(btn){
			...
			$.post("<?php echo Wekit::app()->baseUrl,'/','index.php?m=my&c=follow&a=addtype'; ?>", { name : $('#J_group_creat_input').val() }, function(data){
				if(data.state === 'success') {
					var _data = data.data;
					creat_wrap.remove();
					btn.show();
					...
					//右侧栏写入新分组
					$('#J_side_group_list').append('<li id="J_side_group_'+ _data.id +'"><a class="icon_del J_group_del" href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=my&c=follow&a=deleteType'; ?>&id='+ _data.id +'" data-id="'+ _data.id +'">删除</a><a data-name="'+ _data.name +'" data-id="'+ _data.id +'" class="icon_edit J_group_edit" href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=follow&c=editType&a=%29'; ?>&id='+ _data.id +'">编辑</a><a class="title" href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=my&c=follow'; ?>&type='+ _data.id +'"><span class="J_name">'+ _data.name +'</span><em>(0)</em></a></li>');
	...
	$('#J_side_group_list').data({
		...
		creatsave :  '<?php echo Wekit::app()->baseUrl,'/','index.php?m=my&c=follow&a=addtype'; ?>',
		editsave : '<?php echo Wekit::app()->baseUrl,'/','index.php?m=my&c=follow&a=editType'; ?>',
