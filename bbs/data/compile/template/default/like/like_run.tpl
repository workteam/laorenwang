...
<div class="tac"> </div>
	<div class="main_wrap">
		...
		<div class="bread_crumb">
			<a href="<?php echo Wekit::app()->baseUrl; ?>" class="home" title="<?php echo Wekit::C("site", "info.name"); ?>">首页</a><em>&gt;</em><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=like&c=like'; ?>">喜欢</a><em>&gt;</em><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=like&c=like'; ?>">热门喜欢</a>
		</div>
		<div class="main cc">
			<div class="like_nav cc">
				<ul>
					<li  class="current"><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=like&c=like'; ?>">热门喜欢</a></li>
					<li><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=like&c=mylike&a=ta'; ?>" data-referer="true" class="J_qlogin_trigger" rel="nofollow">Ta的喜欢</a></li>
					<li><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=like&c=mylike'; ?>" data-referer="true" class="J_qlogin_trigger" rel="nofollow">我的喜欢</a></li>
				</ul>
			</div>
...
<script>
var J_LIKE_URL = "<?php echo Wekit::app()->baseUrl,'/','index.php?m=like&c=like&a=data&moduleid=', rawurlencode($datamodule),'&pageid=', rawurlencode($pageid),'&page=', rawurlencode($page); ?>",getdata="<?php echo htmlspecialchars($getdata, ENT_QUOTES, 'UTF-8');?>";
