        ...
        <div id="tab-module-<?php echo $module_row; ?>" class="vtabs-content">
          ...
          <div id="tab-language-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                ...
                <td><textarea name="homelayout_module[<?php echo $module_row; ?>][description][<?php echo $language['language_id']; ?>]" id="description-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>"><?php echo isset($module['description'][$language['language_id']]) ? $module['description'][$language['language_id']] : ''; ?></textarea></td>
              </tr>
            </table>
          </div>
          <?php } ?>
          <table class="form">
            <tr>
              ...
              <td><select name="homelayout_module[<?php echo $module_row; ?>][layout_id]">
            ...
            <tr>
              ...
              <td><select name="homelayout_module[<?php echo $module_row; ?>][position]">
            ...
            <tr>
              ...
              <td><select name="homelayout_module[<?php echo $module_row; ?>][status]">
            ...
            <tr>
              ...
              <td><input type="text" name="homelayout_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
            </tr>
          </table>
        </div>
        <?php $module_row++; ?>
...
function addModule() {	
	...
	html += '          <td><textarea name="homelayout_module[' + module_row + '][description][<?php echo $language['language_id']; ?>]" id="description-' + module_row + '-<?php echo $language['language_id']; ?>"></textarea></td>';
	html += '        </tr>';
	html += '      </table>';
	html += '    </div>';
	<?php } ?>
	...
	html += '      <td><select name="homelayout_module[' + module_row + '][layout_id]">';
	<?php foreach ($layouts as $layout) { ?>
	...
	html += '      <td><select name="homelayout_module[' + module_row + '][position]">';
	...
	html += '      <td><select name="homelayout_module[' + module_row + '][status]">';
	...
	html += '      <td><input type="text" name="homelayout_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
	html += '    </tr>';
	html += '  </table>'; 
	html += '</div>';
