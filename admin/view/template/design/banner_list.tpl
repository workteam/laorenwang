  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons">
          ...
          <a style="display: none" onclick="location = '<?php echo $insert; ?>'" class="button"><?php echo $button_insert; ?></a>


          <a style="display: none" onclick="$('form').submit();" class="button"><?php echo $button_delete; ?></a></div>
    </div>
    <div class="content">
