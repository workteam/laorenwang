...
<div id="content" xmlns="http://www.w3.org/1999/html">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-store"><?php echo $tab_store; ?></a>
          <!-- <a href="#tab-local"><?php echo $tab_local; ?></a>  -->

          <a href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-image"><?php echo $tab_image; ?></a><a href="#tab-mail"><?php echo $tab_mail; ?></a><a href="#tab-fraud"><?php echo $tab_fraud; ?></a>
          <a href="#tab-server"><?php echo $tab_server; ?></a>
          <a href="#tab-diyhome"> 系统首页设置 </a>
      </div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          <table class="form">
            ...
            <tr>
              ...
              <tr>
                     <td> facebook 链接地址  </td>
                     <td>  <input name="config_facebook" value="<?php echo $config_facebook ?>" style="width: 230px;">  </td>
              </tr>
              <tr>
              <td>
                     老人院相关设置  <span class="help"> 多项按回车键增加 <br> </span>
                             ...
                             <table>
                                   <tr>
                                         <td>
                                             ...
                                             <p> <textarea rows="6" cols="20" name="config_homes_env"><?php echo $config_homes_env; ?></textarea></p>
                                         </td>
                                       <td>
                                           <p>  <b> 护理类型: </b>

                                           </p>
                                           <p> <textarea rows="6" cols="20" name="config_homes_nur"><?php echo $config_homes_nur; ?></textarea></p>
                                       </td>
                                       <td>
                                           <p>  <b> 价格类型: </b>

                                           </p>
                                           <p> <textarea rows="6" cols="20" name="config_homes_pri"><?php echo $config_homes_pri; ?></textarea></p>
                                       </td>
            ...
            <tr style="display: none;">
                 <td> cms 模块 <br>
                        <span class="help"> 多个模块按回车键增加 <br>如
                                       [
                                        老人院
                                        招商引资
                                        代理加盟
                 ...
                 <td>
                        <textarea rows="10" cols="40" name="config_cms"><?php echo $config_cms; ?></textarea>
                 </td>
            </tr>
            ...
            <tr>
              ...
              <tr>
                    <td> 友情链接: </td>
                     <td><textarea rows="10" class="fck" cols="40" name="config_links" id='config_links'><?php echo $config_links; ?></textarea> </td>
              </tr>
              <tr>
                  <td> 页面底部: </td>
                  <td><textarea rows="10"  class="fck" cols="40" name="config_footer" id='config_footer'><?php echo $config_footer; ?></textarea> </td>
              </tr>
          </table>
        </div>
        <div id="tab-store">
        ...
        <div id="tab-diyhome">
            <table class="form">
                ...
                <tr>
                    <td>  编辑首页论坛区域内容(上部)  </td>
                    <td><textarea class="fck" type="text" name="config_home_bbs_1" /><?php echo $config_home_bbs_1; ?></textarea></td>
                </tr>
                <tr>
                    <td>  编辑首页论坛区域内容(下部)  </td>
                    <td><textarea class="fck" type="text" name="config_home_bbs_2" /><?php echo $config_home_bbs_2; ?></textarea></td>
                </tr>

                <tr>
                    <td>编辑首页老人院区域内容    </td>
                    <td><textarea class="fck" type="text" name="config_home_homes" /><?php echo $config_home_homes; ?></textarea></td>
                </tr>
