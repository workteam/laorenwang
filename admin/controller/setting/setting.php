...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
        ...
        //////////////  新设置
        if (isset($this->request->post['config_cms'])) {
            $this->data['config_cms'] = $this->request->post['config_cms'];
        } else {
            $this->data['config_cms'] = $this->config->get('config_cms');
        }
        ////////////// 新设置
        ...
        if (isset($this->request->post['config_home_bbs_1'])) {
            $this->data['config_home_bbs_1'] = $this->request->post['config_home_bbs_1'];
        } else {
            $this->data['config_home_bbs_1'] = $this->config->get('config_home_bbs_1');
        }
        if (isset($this->request->post['config_home_bbs_2'])) {
            $this->data['config_home_bbs_2'] = $this->request->post['config_home_bbs_2'];
        } else {
            $this->data['config_home_bbs_2'] = $this->config->get('config_home_bbs_2');
        }
        if (isset($this->request->post['config_home_homes'])) {
            $this->data['config_home_homes'] = $this->request->post['config_home_homes'];
        } else {
            $this->data['config_home_homes'] = $this->config->get('config_home_homes');
        }

        if (isset($this->request->post['config_homes_env'])) {
            $this->data['config_homes_env'] = $this->request->post['config_homes_env'];
        } else {
            $this->data['config_homes_env'] = $this->config->get('config_homes_env');
        }
        if (isset($this->request->post['config_homes_nur'])) {
            $this->data['config_homes_nur'] = $this->request->post['config_homes_nur'];
        } else {
            $this->data['config_homes_nur'] = $this->config->get('config_homes_nur');
        }
        if (isset($this->request->post['config_homes_pri'])) {
            $this->data['config_homes_pri'] = $this->request->post['config_homes_pri'];
        } else {
            $this->data['config_homes_pri'] = $this->config->get('config_homes_pri');
        }

        if (isset($this->request->post['config_links'])) {
            $this->data['config_links'] = $this->request->post['config_links'];
        } else {
            $this->data['config_links'] = $this->config->get('config_links');
        }
        if (isset($this->request->post['config_footer'])) {
            $this->data['config_footer'] = $this->request->post['config_footer'];
        } else {
            $this->data['config_footer'] = $this->config->get('config_footer');
        }
