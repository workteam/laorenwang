...
class ControllerProductCategory extends Controller {  
	public function index() { 
		...
		if ($category_info        ||  1==1       ) {
	  		$this->document->setTitle(     isset($category_info['name']) ?    $category_info['name'] :"商城"            );
			$this->document->setDescription(      isset($category_info['meta_description'])  ?         $category_info['meta_description']     :"商城"           );
			$this->document->setKeywords(      isset( $category_info['meta_keyword']) ?     $category_info['meta_keyword'] :"商城"               );
			
			$this->data['heading_title'] =      isset($category_info['name']) ?       $category_info['name']      :""  ;
			...
			$this->data['description'] = html_entity_decode(    ( isset($category_info['description']) ?      $category_info['description']  :"")        , ENT_QUOTES, 'UTF-8');
