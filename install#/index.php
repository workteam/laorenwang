...
define('HTTP_hczm.cn', 'http://' . $_SERVER['HTTP_HOST'] . rtrim(rtrim(dirname($_SERVER['SCRIPT_NAME']), 'install'), '/.\\'). '/');

// DIR
define('DIR_APPLICATION', str_replace('\'', '/', realpath(dirname(__FILE__))) . '/');
define('DIR_SYSTEM', str_replace('\'', '/', realpath(dirname(__FILE__) . '/../')) . '/system/');
define('DIR_hczm.cn', str_replace('\'', '/', realpath(DIR_APPLICATION . '../')) . '/');
...
if (filesize('../config.php') > 0) {
	...
	$file = file(DIR_hczm.cn . 'config.php');
